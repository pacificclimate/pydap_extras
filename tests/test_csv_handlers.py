...
def test_simple_single_column_selection(simple_data_file):
    ...
    assert retrieved_data == ["Diamond_St", "Blacktail_Loop", "Platinum_St", "Kodiak_Trail"]
...
def test_simpe_filter(simple_data_file):
    ...
    assert list(retrieved_data)==[(11, 13.1, 'Blacktail_Loop'), (12, 13.3, 'Platinum_St'), (13, 12.1, 'Kodiak_Trail')]
